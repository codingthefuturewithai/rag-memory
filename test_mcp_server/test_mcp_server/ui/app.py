"""Streamlit Admin UI for Test MCP Server
...
Run with: streamlit run test_mcp_server/ui/app.py
"""
...
try:
    from test_mcp_server.ui.lib.components import render_header, render_sidebar, render_error_message
    from test_mcp_server.ui.lib.styles import apply_custom_styles, hide_streamlit_style
    from test_mcp_server.ui.lib.utils import get_project_info
    ...
    def render_header():
        st.title("Test MCP Server Admin")
    ...
    def get_project_info():
        return {"name": "Test MCP Server", "version": "0.1.0"}

# Page configuration
st.set_page_config(
    page_title="Test MCP Server Admin",
    page_icon="🛠️",
    layout="wide",
...
def main():
    ...
    try:
        ...
        st.markdown("## Welcome to Test MCP Server Admin Interface")
