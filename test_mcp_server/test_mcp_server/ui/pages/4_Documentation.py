"""Documentation viewer page for Test MCP Server Admin UI
...
def render_documentation_content():
    ...
    st.markdown("""
    This MCP server was generated from the Test MCP Server Cookie Cutter template.
    
    **Getting Started:**
    1. Test your server with MCP Inspector: `mcp dev test_mcp_server/server/app.py`
    2. Run the example client: `test_mcp_server-client "Hello World"`
...
def main():
    ...
    # Page header
    st.title("📖 Test MCP Server Documentation")
