"""Home/Dashboard page for Test MCP Server Admin UI
...
def render_project_overview():
    ...
    with col1:
        ...
        **Project Details:**
        ...
        - **Description:** Test MCP Server - MCP server with tools and integrations
        - **Author:** tim
        - **Email:** tim@gmail.com
        """)
...
def render_system_info():
    ...
    with st.expander("🔍 System Information"):
        try:
            from test_mcp_server.ui.lib.utils import get_system_paths
...
def main():
    """Main page content"""
    # Page header
    st.title("🏠 Test MCP Server Admin Dashboard")
    ...
    # Footer
    st.markdown("---")
    st.caption(f"Test MCP Server Admin UI • Generated with SAAGA MCP Server Cookie Cutter")
