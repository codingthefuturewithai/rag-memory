# Developer Guide - Test MCP Server
...
```python
# test_mcp_server/tools/my_tools.py
...
```python
from test_mcp_server.tools.my_tools import my_tools, my_parallel_tools
```
...
uv run pytest --cov=test_mcp_server --cov-report=html
